...
class ViT_small(nn.Module):
    def __init__(self, *, image_size, patch_size, out_dim, dim, depth, heads, mlp_dim, pool ='cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.):
        super().__init__()
